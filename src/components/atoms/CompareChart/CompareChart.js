        ...
        <ul>
          ...
          <li className='m-auto'>
            <svg width="28" height="20" viewBox="0 0 28 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M25.2727 2L9.27273 18L2 10.7273" stroke="white" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </li>
          <li className='m-auto'>
            <svg width="28" height="20" viewBox="0 0 28 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li className='m-auto'>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M2 2L18 18" stroke="white" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
